...
size_t triangle_split_tree_2d_t::add_point(const point_2d_t &p) {
    // TODO: Make this faster somehow. Using a map didn't seem to work,
    // probably need to use an explicit point tree structure to determine
    // nearest neighbor points / duplicate points.
