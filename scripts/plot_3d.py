...
from tmesh import Line3D, Point3D, Triangle3D, Trimesh3D

Thing = Union[Line3D, Point3D, Triangle3D, Trimesh3D]
...
def plot_line(axes: plt.Axes, line: Line3D, i: int) -> None:
    ...
    axes.plot3D([line.p1.x, line.p2.x], [line.p1.y, line.p2.y], [line.p1.z, line.p2.z], get_color(i))
...
def plot_point(axes: plt.Axes, point: Point3D, i: int) -> None:
    ...
    axes.plot3D(point.x, point.y, point.z, get_color(i) + "o")
